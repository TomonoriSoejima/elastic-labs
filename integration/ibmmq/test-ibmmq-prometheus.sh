...
FLEET_URL="https://0c65f65a8d3a433ebe59d197cc9de947.fleet.asia-northeast1.gcp.cloud.es.io:443"
ENROLLMENT_TOKEN="${FLEET_ENROLLMENT_TOKEN:-REDACTED}"
AGENT_VERSION="9.3.3"

if [[ "$ENROLLMENT_TOKEN" == "REDACTED" ]]; then
...
echo "    FLEET_ENROLLMENT_TOKEN=yourtoken ELASTICSEARCH_HOSTS=http://your-cluster:9200 ELASTICSEARCH_USERNAME=elastic ELASTICSEARCH_PASSWORD=yourpass $0"
echo ""
